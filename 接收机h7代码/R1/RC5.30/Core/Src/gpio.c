...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOG, SUCKER_error_Pin|SUCKER_2_Pin|SUCKER_5_Pin|SUCKER_6_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SUCKER_error_Pin SUCKER_2_Pin SUCKER_5_Pin SUCKER_6_Pin */
  GPIO_InitStruct.Pin = SUCKER_error_Pin|SUCKER_2_Pin|SUCKER_5_Pin|SUCKER_6_Pin;
