...
$testSrc = Join-Path $suiteDir 'test_app_utils_backend.cpp'
...
Invoke-BackendCase -BackendName 'std' -BackendDefine 'JIA_APP_MATH_MODE=JIA_APP_MATH_MODE_STD'
Invoke-BackendCase -BackendName 'dsp' -BackendDefine 'JIA_APP_MATH_MODE=JIA_APP_MATH_MODE_DSP'
