...
#define Dswtich_1_Pin GPIO_PIN_7
#define Dswtich_1_GPIO_Port GPIOE
#define Dswtich_2_Pin GPIO_PIN_8
#define Dswtich_2_GPIO_Port GPIOE
#define Dswtich_3_Pin GPIO_PIN_9
#define Dswtich_3_GPIO_Port GPIOE
#define Dswtich_4_Pin GPIO_PIN_10
#define Dswtich_4_GPIO_Port GPIOE
#define Dswtich_5_Pin GPIO_PIN_11
#define Dswtich_5_GPIO_Port GPIOE
#define Dswtich_6_Pin GPIO_PIN_12
#define Dswtich_6_GPIO_Port GPIOE
#define Dswtich_7_Pin GPIO_PIN_13
#define Dswtich_7_GPIO_Port GPIOE
#define Dswtich_8_Pin GPIO_PIN_14
